    ...
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo; margin:auto">
                <a href="index.php">
                    <img src="images/icon/logos.png" style="width:75px;height: 75px;margin-left:100px;margin-top:10px" alt="Cool Admin" />
                                ...
                                <div class="overview-item overview-item--c3">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2>1,086</h2>
                                                <span>Bu Haftaki Bireysel Ölçüm Adedi</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
